(function (factory) {
  ...
  var helper = {
    createTooltip: function (data) {
      var tooltip = $("<div />", {
        class:
          "tooltipify tooltipify-hide" +
          (data.settings.cssClass ? " " + data.settings.cssClass : ""),
        ...
        .append(
          $("<div />", { class: "content" }).append(
            data.settings.content
              ? data.settings.content
              : $("<span />", { text: data.title, class: "text" })
          )
        )
    ...
    getTooltipHeight: function (tooltip) {
      return (
        ...
        (tooltip.hasClass("left") || tooltip.hasClass("right")
          ? 0
          : tooltip.children(".icon").outerHeight(true))
      );
    },
    getTooltipWidth: function (tooltip) {
      return (
        ...
        (tooltip.hasClass("left") || tooltip.hasClass("right")
          ? tooltip.children(".icon").outerWidth(true)
          : 0)
      );
    },
    getTooltipPosition: function (tooltip, element, settings) {
      ...
      switch (position) {
        ...
        case "right":
          if (
            windowWidth - leftPos > tooltipWidth &&
            leftPos > windowWidth - leftPos
          ) {
            position = "left";
          }
          break;
    ...
    getYPosition: function (position, settings, element, tooltip) {
      ...
      switch (position) {
        case "left":
          return (
            pos.top +
            element.outerHeight(true) / 2 +
            settings.offsetTop -
            helper.getTooltipHeight(tooltip) / 2
          );
        case "right":
          return (
            pos.top +
        ...
        default:
          return (
            pos.top - (helper.getTooltipHeight(tooltip) + settings.offsetTop)
          );
      }
    },
    getXPosition: function (position, settings, element, tooltip) {
      ...
      switch (position) {
        case "left":
          return (
            pos.left + settings.offsetLeft - helper.getTooltipWidth(tooltip)
          );
        case "right":
          return (
            pos.left +
  ...
  var events = {
    show: function () {
      ...
      if (settings.animationProperty) {
        var orgValue = parseInt(
          tooltip.css(settings.animationProperty).replace(/[^-\d\.]/g, "")
        );
        tooltip.css(
          settings.animationProperty,
          orgValue - settings.animationOffset
        );
        animation[settings.animationProperty] = "+=" + settings.animationOffset;
      }
      tooltip
        .removeClass("tooltipify-hide")
    ...
    hide: function () {
      ...
      var data = $this.data("tooltipify");
      var tooltip = data.tooltip;
      if (!tooltip || !tooltip.length || !tooltip.is(":visible")) {
        return;
      }
      if (data.cssPosition) {
  ...
  var methods = {
    init: function (options) {
      ...
      return $(this).each(function () {
        ...
        if (!data) {
          $this
            .bind(settings.showEvent, events.show)
    ...
    destroy: function () {
      return this.each(function () {
        ...
        if (data) {
          ...
          $this
            .unbind(data.settings.showEvent, events.show)
